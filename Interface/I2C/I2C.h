#ifndef __SN32F700B_I2C_H
#define __SN32F700B_I2C_H
...
#define mskI2C_GCEN_DIS										(I2C_GCEN_DIS<<7)
#define	mskI2C_GCEN_EN										(I2C_GCEN_EN<<7)

																								//[31:31]Slave address mode
#define	I2C_ADD_MODE_7BIT									0			//7-bit address mode
#define	I2C_ADD_MODE_10BIT								1			//10-bit address mode
#define mskI2C_ADD_MODE_7BIT							(I2C_ADD_MODE_7BIT<<7)
#define	mskI2C_ADD_MODE_10BIT							(I2C_ADD_MODE_10BIT<<7)
...
#define I2C_PROTOCOL_HEAD                 0xA5 
#define I2C_PROTOCOL_LEN                  5 
#define I2C_HEAD                          0        
#define I2C_LENGTH_HIGH                   1
#define I2C_LENGTH_LOW                    2
#define I2C_OP_CODE                       3
#define I2C_PARAMETER                     4

//master ->slave
#define I2C_POWER_SWITCH                  0x51
#define I2C_SOFT_RESET                    0x52
#define I2C_LIGHT_SWITCH                  0x61	
#define I2C_LIGHT_BRIGHTNESS              0x62
#define I2C_GET_LIGHT_STATUS              0x63
#define I2C_UPDATE_LIGHT_STATUS_ACK       0x64
#define I2C_UPDATE_LIGHT_SET_ACK          0x65
#define I2C_UPDATE_LIGHT_SET_COMPLETE_ACK 0x66
#define I2C_GET_VERSION                   0x67

//slave -> master
#define I2C_POWER_SWITCH_ACK              0xD1
#define I2C_SOFT_RESET_ACK                0xD2
#define I2C_LIGHT_SWITCH_ACK              0xE1
#define I2C_LIGHT_BRIGHTNESS_ACK          0xE2
#define I2C_GET_LIGHT_STATUS_ACK          0xE3
#define I2C_UPDATE_LIGHT_STATUS           0xE4
#define I2C_UPDATE_LIGHT_SET              0xE5
#define I2C_UPDATE_LIGHT_SET_COMPLETE     0xE6
#define I2C_GET_VERSION_ACK               0xE7
...
void I2C0_Slave_Rx(void);
void I2C0_Slave_Tx(void);
#endif	/*__SN32F700B_I2C_H*/
